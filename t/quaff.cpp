    ...
    prog (argv[0])
{
  ...
  text = briefText
    ...
    + "   -kmer           Length of kmers, for pre-screening heuristic (default " + to_string(DEFAULT_KMER_LENGTH) + ")\n"
    + "   -kmatch <n>     Threshold of kmer matches for a diagonal to be included\n"
    + "   -kmatchsd <n>   Set threshold to n std.devs. above background (default " + to_string(DEFAULT_KMER_STDEV_THRESHOLD) + ")\n"
